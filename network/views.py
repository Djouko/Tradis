...
def home(request, id):
    ...
    return render(request,"sites/index.html", {'post': post})


def about(request, id):
    post = get_object_or_404(Post, id=id)
    return render(request,"sites/about.html", {'post': post})


def booking(request, id):
    post = get_object_or_404(Post, id=id)
    return render(request,"sites/booking.html", {'post': post})


def contact(request, id):
    post = get_object_or_404(Post, id=id)
    return render(request,"sites/contact.html", {'post': post})


def destination(request, id):
    post = get_object_or_404(Post, id=id)
    return render(request,"sites/destination.html", {'post': post})


def package(request, id):
    post = get_object_or_404(Post, id=id)
    return render(request,"sites/package.html", {'post': post})


def service(request, id):
    post = get_object_or_404(Post, id=id)
    return render(request,"sites/service.html", {'post': post})


def team(request, id):
    post = get_object_or_404(Post, id=id)
    return render(request,"sites/team.html", {'post': post})


def testimonial(request, id):
    post = get_object_or_404(Post, id=id)
    return render(request,"sites/testimonial.html", {'post': post})


def l404(request, exception):
